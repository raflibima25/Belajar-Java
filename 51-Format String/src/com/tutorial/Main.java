...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // udin, wahai udin, kemana aja kamu udin?
        System.out.printf("%1$s, wahai %1$s, kemana aja kamu %1$s?\n",nama);
        ...
        System.out.printf("% 10d\n",int3);
        System.out.printf("%010d\n",int3); // flags "0", kita menambahkan sebagai leading "0" di depan
        System.out.printf("%+010d\n",int3);
        int int4 = 1000000000;
